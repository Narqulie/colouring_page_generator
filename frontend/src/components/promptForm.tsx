  ...
  return (
    ...
    >
      ...
      <input
        ...
        className="min-h-14 w-full rounded-2xl border-2 border-[#fff7e9]/70 bg-[#fffaf2] px-5 py-3.5 text-base text-[#25213a] shadow-[0_3px_12px_rgba(16,9,29,0.18)] transition-[border-color,box-shadow,background-color] duration-200 placeholder:text-[#716d7e] hover:bg-[#fffdf8] focus-visible:border-[#3d276d] focus-visible:bg-[#fffdf8] focus-visible:shadow-[0_4px_20px_rgba(16,9,29,0.24)] disabled:cursor-wait disabled:opacity-65 sm:text-lg"
      />
